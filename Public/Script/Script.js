  ...
  if (data == "") {
    ...
    if (Nombre == "" || cedula == "" || Tipopersonal == "" || telefono == "" || correo == "" || OneDrive == "") {
      ...
      if (imagen != "" & imagen.length > 1000000) {
        ...
        fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/Ingresar', {
      ...
      if (unidad == "") {
        ...
        if (areao == "") {
          ...
          if (nivel == "") {
            ...
            fetch('https://hojas-de-vida.herokuapp.com/Formacion/Insertar', {
            ...
            fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/Actualizarformaciones', {
              method: 'POST', body: JSON.stringify(dataFormacion),
              headers: {
                'Content-Type': 'application/json'
              }
            ...
            var cedu = { Cedula: cedula };
            const Formaciones = await fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/ConsultarFormacionesIngresar', {
              method: 'POST', body: JSON.stringify(cedu),
              headers: {
                'Content-Type': 'application/json'
              }
        ...
        if (entidad2 == "") {
          ...
          if (meses_Experiencia2 == "") {
            ...
            if (areao == "" || areao == "Selecciona un área de experiencia") {
              ...
              fetch('https://hojas-de-vida.herokuapp.com/Experiencia/Insertar', {
              ...
              fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/ActualizarExperiencias', {
                method: 'POST', body: JSON.stringify(dataPerson),
                headers: {
                  'Content-Type': 'application/json'
                }
              ...
              const Experiencias = await fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/ConsultarExperienciasIngresar', {
                method: 'POST', body: JSON.stringify(cedu),
                headers: {
                  'Content-Type': 'application/json'
                }
...
async function MandarActualizar() {
  ...
  if (Nombre == "" || cedula == "" || Tipopersonal == "" || telefono == "" || correo == "" || OneDrive == "") {
    ...
    fetch('https://hojas-de-vida.herokuapp.com/HojaDeVida/Actualizar', {
